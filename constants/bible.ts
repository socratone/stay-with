...
export const BIBLE_LABEL = {
  ...
  [Bible.Colossians]: '콜로',
  [Bible.ThessaloniansFirst]: '1테살',
  [Bible.ThessaloniansSecond]: '2테살',
...
export const BIBLE_INTRO: any = {
  [Bible.Genesis]: '창세기의 말씀입니다.',
  // [Bible.Exodus]: '탈출',
  // [Bible.Leviticus]: '레위',
  // [Bible.Numbers]: '민수',
  // [Bible.Deuteronomy]: '신명',
  ...
  // [Bible.Zechariah]: '즈카',
  // [Bible.Malachi]: '말라',
  [Bible.Matthew]: '마태오가 전한 거룩한 복음입니다.',
  [Bible.Mark]: '마르코가 전한 거룩한 복음입니다.',
  [Bible.Luke]: '루카가 전한 거룩한 복음입니다.',
  [Bible.John]: '요한이 전한 거룩한 복음입니다.',
  [Bible.Acts]: '사도행전의 말씀입니다.',
  // [Bible.Romans]: '로마',
  // [Bible.CorinthiansFirst]: '1코린',
  // [Bible.CorinthiansSecond]: '2코린',
  // [Bible.Galatians]: '갈라',
  ...
  // [Bible.ThessaloniansSecond]: '2테살',
  // [Bible.TimothyFirst]: '1티모',
  // [Bible.TimothySecond]: '사도 바오로의 티모테오 2서 말씀입니다.',
  // [Bible.Titus]: '티토',
  // [Bible.Philemon]: '필레',
  // [Bible.Hebrews]: '히브',
  // [Bible.James]: '야고',
